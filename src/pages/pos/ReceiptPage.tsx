                            ...
                            <div className="d-flex flex-column gap-2">
                                {order.items.map((item) => (
                                    <div key={item.id} className="d-flex border-bottom pb-2 px-3 text-muted align-items-center">
                                        ...
                                        <div style={{ flex: 1, textAlign: 'center' }}>${item.unit_price.toFixed(2)}</div>
                                        <div style={{ flex: 1, textAlign: 'center' }}>{item.quantity}0</div>
                                        <div style={{ flex: 1, textAlign: 'right' }} className="fw-bold text-dark">${item.subtotal.toFixed(2)}</div>
                                    </div>
                                ))}
                                ...
                                <div className="px-2">
                                    ...
                                    <div className="mt-3 pt-2 border-top">
                                        {order.payments.map((p, i) => (
                                            <div key={i} className="small text-muted">{p.method}: ${p.amount.toFixed(2)}</div>
                                        ))}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-6">
                                <div className="px-4">
                                    <div className="d-flex justify-content-between mb-2 fw-medium text-muted">
                                        <span>Subtotal</span>
                                        <span className="text-dark">${order.total_amount.toFixed(2)}</span>
                                    </div>
                                    ...
                                    <div className="d-flex justify-content-between py-2 px-3 text-white fw-bold align-items-center" style={{ backgroundColor: themeColor }}>
                                        ...
                                        <span className="fs-5">${order.total_amount.toFixed(2)}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
